...
DELITOS_RECHAZAR = {
    ...
    "TRAFICO DE INFLUENCIAS", "TRÁFICO DE INFLUENCIAS",
    # Tenencia ilegal armas (no de guerra)
    "TENENCIA ILEGAL DE ARMAS",
    # Daños
    "DANOS", "DAÑOS", "INCENDIO",
    # Patrimonio / contrabando
    "USURPACION", "USURPACIÓN", "CONTRABANDO",
    # Delitos digitales
    "DELITO INFORMATICO", "DELITO INFORMÁTICO",
    "ACCESO NO AUTORIZADO", "CIBERNETICO", "CIBERNÉTICO",
}
...
DELITOS_OBSERVACION = {
    ...
    # Laboral / civil patrimonial
    "DESPIDO INTEMPESTIVO", "DESAHUCIO",
    "COBRO DE CHEQUE", "CHEQUE",
    "NULIDAD DE CONTRATO", "NULIDAD",
    "PARTICION DE BIENES", "PARTICIÓN DE BIENES",
    "HERENCIA", "SUCESION", "SUCESIÓN",
    "PRESCRIPCION ADQUISITIVA", "PRESCRIPCIÓN ADQUISITIVA",
    "CONCURSO DE ACREEDORES",
    # Honor / reputación
    "INJURIA", "CALUMNIA", "DIFAMACION", "DIFAMACIÓN",
    # Conductas leves / personales (criterio HR)
    "ABUSO DE CONFIANZA",
    "INTIMIDACION", "INTIMIDACIÓN",
    "ACOSO",
    "DERECHOS DE AUTOR",
    "INCUMPLIMIENTO DE DECISION", "INCUMPLIMIENTO DE DECISIÓN",
